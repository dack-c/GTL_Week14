...
BEGIN_PROPERTIES(UDecalComponent)
    ...
    ADD_PROPERTY_TEXTURE(UTexture*, DecalTexture, "Decal", true, "데칼 텍스처")
    ADD_PROPERTY_RANGE(float, DecalOpacity, "Decal", 0.0f, 1.0f, true, "데칼 불투명도")
    ADD_PROPERTY_RANGE(float, FadeSpeed, "Decal", 0.0f, 10.0f, true, "페이드 속도 (초당 변화량)")
END_PROPERTIES()
