...
#define U_TRIGGER_COMPONENT_BODY \
public: \
    using Super = USceneComponent; \
    using ThisClass_t = UTriggerComponent; \
    static UClass* StaticClass() \
    { \
        static UClass Cls{ "UTriggerComponent", USceneComponent::StaticClass(), sizeof(UTriggerComponent) }; \
        static bool bRegistered = (UClass::SignUpClass(&Cls), true); \
        return &Cls; \
    } \
    virtual UClass* GetClass() const override { return UTriggerComponent::StaticClass(); } \
    UTriggerComponent(const UTriggerComponent&) = default; \
    UTriggerComponent* Duplicate() const override \
    { \
        UTriggerComponent* NewObject = ObjectFactory::DuplicateObject<UTriggerComponent>(this); \
...
#define CURRENT_CLASS_GENERATED_BODY U_TRIGGER_COMPONENT_BODY
