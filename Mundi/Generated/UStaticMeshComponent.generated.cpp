...
BEGIN_PROPERTIES(UStaticMeshComponent)
    ...
    ADD_PROPERTY(FVector, BoxExtent, "", false)
    ADD_PROPERTY(float, SphereRadius, "", false)
    ADD_PROPERTY(float, CapsuleRadius, "", false)
    ADD_PROPERTY(float, CapsuleHalfHeight, "", false)
    ADD_PROPERTY(FVector, CollisionOffset, "", false)
    ADD_PROPERTY(FQuat, CollisionRotation, "", false)
    ADD_PROPERTY(class UBodySetup*, BodySetupOverride, "", false)
